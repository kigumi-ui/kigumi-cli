...
│   ├── react/            # ReactPlugin — detects react (incl. Next.js via `next` dep), generates .tsx/.jsx + .test + .css
│   ├── vue/              # VuePlugin — detects vue, generates .vue/.js.vue + .test + .css
│   ├── angular/          # AngularPlugin — detects @angular/core, generates .component.ts + .component.spec.ts + .component.css. No web-awesome.d.ts (uses CUSTOM_ELEMENTS_SCHEMA). No clsx. TypeScript-only. Templates generated by scripts/generate-angular-templates.ts — do not hand-edit.
│   └── svelte/           # SveltePlugin (stub — not fully implemented)
