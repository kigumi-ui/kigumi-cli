...
```
tests/
├── unit/                    # Fast, isolated tests (98 files at top level, ~1500 tests; more under eslint-rules/, scripts/, schemas/)
