...
│   ├── package-json-read-error.test.ts # PackageJsonReadError / PackageJsonInvalidError + what `kigumi list`, `init`, `upgrade` and `brand` print for a broken package.json (issue #99)
...
| `init`                   | invalid JSON in `package.json`                 | `PackageJsonInvalidError`, exit 4 | `tests/unit/package-json-read-error.test.ts`      | `kigumi init reports invalid JSON in package.json`                           |
...
| `upgrade`                | unreadable `package.json` (a directory)        | `PackageJsonReadError`, exit 4    | `tests/unit/package-json-read-error.test.ts`      | `kigumi upgrade reports a directory at package.json`                         |
...
| `brand`                  | unreadable `package.json` (a directory)        | `PackageJsonReadError`, exit 4    | `tests/unit/package-json-read-error.test.ts`      | `kigumi brand reports a directory at package.json`                           |
...
| `list`                   | `package.json` is a directory                  | `PackageJsonReadError`, exit 4    | `tests/unit/package-json-read-error.test.ts`      | `kigumi list reports a directory at package.json`                            |
| `list`                   | `package.json` not readable (EACCES)           | `PackageJsonReadError`, exit 4    | `tests/unit/package-json-read-error.test.ts`      | `kigumi list reports an unreadable package.json with a permissions fix`      |
