...
**Version**: 1.0.2 | **Stack**: TypeScript, Commander, Zod
...
| `scripts/find-cem.ts`                    | Resolve the Web Awesome CEM on disk, scoped to one root: `resolveCem()` returns path + tier (pro/free) + component count. Shared by the parser, the skill-reference generator and the freshness guard                                                                                                                                                                                                                                             |
