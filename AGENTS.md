...
**Version**: 0.25.0 | **Stack**: TypeScript, Commander, Zod
...
Do not add a `'next'` entry to the `framework` enum — duplicating templates under `templates/nextjs/` would force parallel maintenance of 79 components for no gain.
...
flowchart TD
    ...
    subgraph Templates["templates/"]
        tpl_react["react/ — 79 components\n.tsx, .jsx\n.test.tsx, .test.jsx, .css"]
        tpl_vue["vue/ — 79 components\n.vue, .js.vue\n.test.ts, .test.js, .css"]
        tpl_angular["angular/ — 79 components\n.component.ts, .component.spec.ts, .component.css"]
    end
...
**Maintained by:** AI Assistants | **Last Updated:** 2026-07-01 (Web Awesome 3.9.0; 79 components after adding checkbox-group)
