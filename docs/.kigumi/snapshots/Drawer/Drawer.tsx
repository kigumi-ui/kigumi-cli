...
import type WaElement from '@awesome.me/webawesome-pro/dist/components/drawer/drawer.js';
import './Drawer.css';

/** WaDrawer declares show/requestClose as private; redeclare as public for imperative use */
type DrawerElement = Omit<WaElement, 'open' | 'show' | 'requestClose'> & {
  open?: boolean;
  show?: () => Promise<void>;
 ...
 * <Drawer ref={(el: WaElement | null) => { drawerRef.current = el; }} label="Drawer Title">
 *   <p>Drawer content</p>
 * </Drawer>
 * ```
 */
    ...
    return createPortal(
      <wa-drawer
        ref={(el: WaElement | null) => {
          drawerRef.current = el as unknown as DrawerElement;
        }}
