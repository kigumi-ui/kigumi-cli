        ...
        <div className="wa-stack wa-gap-xl">
          ...
          <div className="wa-stack wa-gap-m">
            ...
            <p className="wa-caption-m">
              Set up Kigumi in your React, Vue, Angular, or Next.js project. Choose your framework
              ...
              <a href="?path=/docs/general-faq--docs">FAQ</a> for 401 errors.
            </p>
            ...
            <p className="wa-caption-m">
              ...
              HTML to React, Vue, Angular, or Next.js components and customize themes.
            </p>
            <pre>
          ...
          <div className="wa-stack wa-gap-m">
            <div className="wa-cluster wa-gap-xs wa-align-items-center">
              <Badge pill>3</Badge>
              <h3 className="wa-heading-l" id="import">Import Kigumi</h3>
            </div>
          ...
          <div className="wa-stack wa-gap-m">
            ...
            <p className="wa-caption-m">
              Import and use components in your React, Vue, Angular, or Next.js code:
            </p>
