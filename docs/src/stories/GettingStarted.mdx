        ...
        <div className="wa-stack wa-gap-xl">
          ...
          <div className="wa-stack wa-gap-m">
            ...
            <p className="wa-caption-m">
              Set up Kigumi in your React, Vue, or Angular project. Choose your framework
              ...
              <a href="?path=/docs/general-troubleshooting--docs">Troubleshooting</a> for 401 errors.
            </p>
