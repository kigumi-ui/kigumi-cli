...
**Web Awesome**: `wa-pie-chart`  
**Kigumi React**: `<PieChart>`  
**Category**: Data Display  
**Tier**: pro

React wrapper component for the Web Awesome `wa-pie-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-pie-chart label="value" description="value">Click me</wa-pie-chart>
```
...
<PieChart label="value" description="value">
  Click me
</PieChart>;
```
...
```bash
npx kigumi add pie-chart
```

---

**Documentation**: [webawesome.com/docs/components/pie-chart](https://webawesome.com/docs/components/pie-chart)
