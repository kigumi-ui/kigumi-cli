...
| --------------- | --------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| `change`        | `onChange`      | `Event`       | Emitted when the color picker's value changes.                                                    |
| `input`         | `onInput`       | `InputEvent`  | Emitted when the color picker receives input.                                                     |
...
| `blur`          | `onBlur`        | `FocusEvent`  | Emitted when the color picker loses focus.                                                        |
| `focus`         | `onFocus`       | `FocusEvent`  | Emitted when the color picker receives focus.                                                     |
