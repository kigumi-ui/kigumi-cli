...
| --------------- | --------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| `wa-show`       | `onWaShow`      | `CustomEvent` | Emitted when the popover begins to show. Canceling this event will stop the popover from showing. |
| `wa-after-show` | `onWaAfterShow` | `CustomEvent` | Emitted after the popover has shown and all animations are complete.                              |
| `wa-hide`       | `onWaHide`      | `CustomEvent` | Emitted when the popover begins to hide. Canceling this event will stop the popover from hiding.  |
| `wa-after-hide` | `onWaAfterHide` | `CustomEvent` | Emitted after the popover has hidden and all animations are complete.                             |
