...
| `wa-show`       | `onWaShow`      | `CustomEvent` | Emitted when the combobox's menu opens.                                                                                                                             |
| `wa-after-show` | `onWaAfterShow` | `CustomEvent` | Emitted after the combobox's menu opens and all animations are complete.                                                                                            |
| `wa-hide`       | `onWaHide`      | `CustomEvent` | Emitted when the combobox's menu closes.                                                                                                                            |
| `wa-after-hide` | `onWaAfterHide` | `CustomEvent` | Emitted after the combobox's menu closes and all animations are complete.                                                                                           |
| `wa-create`     | `onWaCreate`    | `CustomEvent` | Emitted when the user selects the "create" option. Call `event.preventDefault()` to handle creation yourself. The event `detail` contains `{ inputValue: string }`. |
