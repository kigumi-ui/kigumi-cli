...
| --------------- | --------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `wa-show`       | `onWaShow`      | `CustomEvent` | Emitted when the drawer opens.                                                                                                                                                                                                                                                                                                                                                                                                              |
| `wa-after-show` | `onWaAfterShow` | `CustomEvent` | Emitted after the drawer opens and all animations are complete.                                                                                                                                                                                                                                                                                                                                                                             |
...
| `wa-after-hide` | `onWaAfterHide` | `CustomEvent` | Emitted after the drawer closes and all animations are complete.                                                                                                                                                                                                                                                                                                                                                                            |
