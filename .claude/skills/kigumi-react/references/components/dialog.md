...
| --------------- | --------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `wa-show`       | `onWaShow`      | `CustomEvent` | Emitted when the dialog opens.                                                                                                                                                                                                                                                                                                                                                                                                             |
| `wa-after-show` | `onWaAfterShow` | `CustomEvent` | Emitted after the dialog opens and all animations are complete.                                                                                                                                                                                                                                                                                                                                                                            |
...
| `wa-after-hide` | `onWaAfterHide` | `CustomEvent` | Emitted after the dialog closes and all animations are complete.                                                                                                                                                                                                                                                                                                                                                                           |
