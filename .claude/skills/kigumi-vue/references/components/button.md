...
Vue wrapper component for the Web Awesome `wa-button` element.
...
<template>
  <Button variant="neutral" appearance="accent"> Click me </Button>
</template>
```
...
| ------------ | ------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| `blur`       | `@blur`       | `FocusEvent`  | Emitted when the button loses focus.                                                              |
| `focus`      | `@focus`      | `FocusEvent`  | Emitted when the button gains focus.                                                              |
