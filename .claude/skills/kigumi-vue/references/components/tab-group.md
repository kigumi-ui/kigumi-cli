...
Vue wrapper component for the Web Awesome `wa-tab-group` element.
...
<template>
  <TabGroup placement="top" activation="auto"> Click me </TabGroup>
</template>
```
...
| ------------- | -------------- | ------------- | ----------------------------- |
| `wa-tab-show` | `@wa-tab-show` | `CustomEvent` | Emitted when a tab is shown.  |
| `wa-tab-hide` | `@wa-tab-hide` | `CustomEvent` | Emitted when a tab is hidden. |
