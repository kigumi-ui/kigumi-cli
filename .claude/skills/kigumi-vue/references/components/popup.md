...
Vue wrapper component for the Web Awesome `wa-popup` element.
...
<template>
  <Popup active anchor="value"> Click me </Popup>
</template>
```
...
| --------------- | ---------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `wa-reposition` | `@wa-reposition` | `CustomEvent` | Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive operations in your listener or consider debouncing it. |
