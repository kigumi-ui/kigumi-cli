...
Vue wrapper component for the Web Awesome `wa-carousel` element.
...
<template>
  <Carousel autoplay autoplay-interval="3000"> Click me </Carousel>
</template>
```
...
| ----------------- | ------------------ | ------------- | -------------------------------------- |
| `wa-slide-change` | `@wa-slide-change` | `CustomEvent` | Emitted when the active slide changes. |
