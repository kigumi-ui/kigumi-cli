...
**Web Awesome**: `wa-scatter-chart`  
**Kigumi Vue**: `<ScatterChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-scatter-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-scatter-chart label="value" description="value">Click me</wa-scatter-chart>
```
...
<template>
  <ScatterChart label="value" description="value"> Click me </ScatterChart>
</template>
```
...
```bash
npx kigumi add scatter-chart
```

---

**Documentation**: [webawesome.com/docs/components/scatter-chart](https://webawesome.com/docs/components/scatter-chart)
