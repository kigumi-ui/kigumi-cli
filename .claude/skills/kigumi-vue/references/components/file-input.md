...
**Kigumi Vue**: `<FileInput>`  
**Category**: Form Controls  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-file-input` element.
...
<template>
  <FileInput label="value" hint="value"> Click me </FileInput>
</template>
```
...
| ------------ | ------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| `input`      | `@input`      | `InputEvent`  | Emitted when file selection changes.                                                              |
| `change`     | `@change`     | `Event`       | Emitted when files are added or removed.                                                          |
| `focus`      | `@focus`      | `FocusEvent`  | Emitted when the dropzone gains focus.                                                            |
| `blur`       | `@blur`       | `FocusEvent`  | Emitted when the dropzone loses focus.                                                            |
