...
Vue wrapper component for the Web Awesome `wa-checkbox` element.
...
<template>
  <Checkbox checked disabled> Click me </Checkbox>
</template>
```
...
| ------------ | ------------- | ------------- | ------------------------------------------------------------------------------------------------- |
| `change`     | `@change`     | `Event`       | Emitted when the checked state changes.                                                           |
| `blur`       | `@blur`       | `FocusEvent`  | Emitted when the checkbox loses focus.                                                            |
| `focus`      | `@focus`      | `FocusEvent`  | Emitted when the checkbox gains focus.                                                            |
| `input`      | `@input`      | `InputEvent`  | Emitted when the checkbox receives input.                                                         |
