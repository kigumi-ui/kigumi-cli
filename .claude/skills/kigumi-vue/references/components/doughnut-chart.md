...
**Web Awesome**: `wa-doughnut-chart`  
**Kigumi Vue**: `<DoughnutChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-doughnut-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-doughnut-chart label="value" description="value"
  >Click me</wa-doughnut-chart
>
```
...
<template>
  <DoughnutChart label="value" description="value"> Click me </DoughnutChart>
</template>
```
...
```bash
npx kigumi add doughnut-chart
```

---

**Documentation**: [webawesome.com/docs/components/doughnut-chart](https://webawesome.com/docs/components/doughnut-chart)
