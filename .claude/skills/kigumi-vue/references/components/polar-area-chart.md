...
**Kigumi Vue**: `<PolarAreaChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-polar-area-chart` element.
...
<template>
  <PolarAreaChart label="value" description="value"> Click me </PolarAreaChart>
</template>
```
