...
Vue wrapper component for the Web Awesome `wa-tooltip` element.
...
<template>
  <Tooltip placement="top" disabled> Click me </Tooltip>
</template>
```
...
| --------------- | ---------------- | ------------- | --------------------------------------------------------------------- |
| `wa-show`       | `@wa-show`       | `CustomEvent` | Emitted when the tooltip begins to show.                              |
| `wa-after-show` | `@wa-after-show` | `CustomEvent` | Emitted after the tooltip has shown and all animations are complete.  |
| `wa-hide`       | `@wa-hide`       | `CustomEvent` | Emitted when the tooltip begins to hide.                              |
| `wa-after-hide` | `@wa-after-hide` | `CustomEvent` | Emitted after the tooltip has hidden and all animations are complete. |
