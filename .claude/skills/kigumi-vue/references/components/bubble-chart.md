...
**Web Awesome**: `wa-bubble-chart`  
**Kigumi Vue**: `<BubbleChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-bubble-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-bubble-chart label="value" description="value">Click me</wa-bubble-chart>
```
...
<template>
  <BubbleChart label="value" description="value"> Click me </BubbleChart>
</template>
```
...
```bash
npx kigumi add bubble-chart
```

---

**Documentation**: [webawesome.com/docs/components/bubble-chart](https://webawesome.com/docs/components/bubble-chart)
