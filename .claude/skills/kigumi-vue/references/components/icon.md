...
Vue wrapper component for the Web Awesome `wa-icon` element.
...
<template>
  <Icon name="value" library="default"> Click me </Icon>
</template>
```
...
| ---------- | ----------- | ------------- | ------------------------------------------------------------------------------------------------------- |
| `wa-load`  | `@wa-load`  | `CustomEvent` | Emitted when the icon has loaded. When using `spriteSheet: true` this will not emit.                    |
| `wa-error` | `@wa-error` | `CustomEvent` | Emitted when the icon fails to load due to an error. When using `spriteSheet: true` this will not emit. |
