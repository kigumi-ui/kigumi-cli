...
**Web Awesome**: `wa-line-chart`  
**Kigumi Vue**: `<LineChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-line-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-line-chart label="value" description="value">Click me</wa-line-chart>
```
...
<template>
  <LineChart label="value" description="value"> Click me </LineChart>
</template>
```
...
```bash
npx kigumi add line-chart
```

---

**Documentation**: [webawesome.com/docs/components/line-chart](https://webawesome.com/docs/components/line-chart)
