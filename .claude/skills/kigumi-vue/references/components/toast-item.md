...
**Kigumi Vue**: `<ToastItem>`  
**Category**: Feedback  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-toast-item` element.
...
<template>
  <ToastItem variant="brand" size="small"> Click me </ToastItem>
</template>
```
...
| --------------- | ---------------- | ------------- | -------------------------------------------------- |
| `wa-show`       | `@wa-show`       | `CustomEvent` | Emitted when the toast item begins to show.        |
| `wa-after-show` | `@wa-after-show` | `CustomEvent` | Emitted after the toast item has finished showing. |
| `wa-hide`       | `@wa-hide`       | `CustomEvent` | Emitted when the toast item begins to hide.        |
| `wa-after-hide` | `@wa-after-hide` | `CustomEvent` | Emitted after the toast item has finished hiding.  |
