...
Vue wrapper component for the Web Awesome `wa-rating` element.
...
<template>
  <Rating label="''" value="0"> Click me </Rating>
</template>
```
...
| ---------- | ----------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `change`   | `@change`   | `Event`       | Emitted when the rating's value changes.                                                                                                                                                                                                    |
| `wa-hover` | `@wa-hover` | `CustomEvent` | Emitted when the user hovers over a value. The `phase` property indicates when hovering starts, moves to a new value, or ends. The `value` property tells what the rating's value would be if the user were to commit to the hovered value. |
