...
**Web Awesome**: `wa-radar-chart`  
**Kigumi Vue**: `<RadarChart>`  
**Category**: Data Display  
**Tier**: pro

Vue wrapper component for the Web Awesome `wa-radar-chart` element.

## Transformation Example

```html
<!-- Web Awesome -->
<wa-radar-chart label="value" description="value">Click me</wa-radar-chart>
```
...
<template>
  <RadarChart label="value" description="value"> Click me </RadarChart>
</template>
```
...
```bash
npx kigumi add radar-chart
```

---

**Documentation**: [webawesome.com/docs/components/radar-chart](https://webawesome.com/docs/components/radar-chart)
