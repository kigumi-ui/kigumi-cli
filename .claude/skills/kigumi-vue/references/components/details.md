...
Vue wrapper component for the Web Awesome `wa-details` element.
...
<template>
  <Details open summary="value"> Click me </Details>
</template>
```
...
| --------------- | ---------------- | ------------- | ----------------------------------------------------------------- |
| `wa-show`       | `@wa-show`       | `CustomEvent` | Emitted when the details opens.                                   |
| `wa-after-show` | `@wa-after-show` | `CustomEvent` | Emitted after the details opens and all animations are complete.  |
| `wa-hide`       | `@wa-hide`       | `CustomEvent` | Emitted when the details closes.                                  |
| `wa-after-hide` | `@wa-after-hide` | `CustomEvent` | Emitted after the details closes and all animations are complete. |
