 ...
 *   npx kigumi add badge card divider format-number icon
 *
 * Responsive Behavior (zero @media queries):
 * - Metric cards (.wa-grid, --min-column-size: 220px):
 *     Desktop (>1100px): 4 columns | Tablet (~700-1100px): 2 columns | Mobile (<700px): 1 column
 * - Chart + Activity (.wa-grid, --min-column-size: 350px):
 *     Desktop (>800px): 2 columns side-by-side | Mobile (<800px): stacked vertically
 * - Header (.wa-split): title and badge pushed to opposite ends, collapses naturally
 */
