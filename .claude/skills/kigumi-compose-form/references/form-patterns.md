...
Complete form patterns with React and Vue code (Next.js uses the React patterns).
...
<template>
  ...
  >
    ...
    <Checkbox
      @change="
        (e: Event) => (remember = (e.target as HTMLInputElement).checked)
      "
  ...
  return (
    ...
    >
      ...
      <TabGroup>
        ...
        <Tab slot="nav" panel="preferences">
          Preferences
        </Tab>
        ...
        <TabPanel name="notifications">
          <div className="wa-stack wa-gap-m">
            <Switch name="emailNotifs" checked>
              Email notifications
            </Switch>
            <Switch name="pushNotifs">Push notifications</Switch>
            <Switch name="weeklyDigest" checked>
              Weekly digest
            </Switch>
          </div>
        </TabPanel>
